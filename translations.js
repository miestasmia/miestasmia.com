...
var translations = {
    en: {
        ...
        footer: "Made with pride 🌈 and love ❤ by Mia Nordentoft Imperatori",
        copyright: "© Mia Nordentoft Imperatori {0}",
    ...
    da: {
        ...
        footer: "Lavet med pride 🌈 og kærlighed ❤ af Mia Nordentoft Imperatori",
        copyright: "© Mia Nordentoft Imperatori {0}",
    ...
    eo: {
        ...
        contact2: "Se vi ion pli privatan bezonas, bonvolu al mi retmesaĝon sendi per {0}. Bonvole uzu OpenPGP-on kiam vi min kontaktas; mi verŝajne vian mesaĝon ignoros se vi ne ĝin ĉifris kaj subskribis. Mia spamfiltrilo ankaŭ iom avidas, sed iu ajn OpenPGP-a retmesaĝo plusendiĝos. Vi {1}ĉi tie{2} mian publikan ŝlosilon trovi povas.",
        gpgFingerprint: "GPG-fingropremo:",
        footer: "Farita per fiero 🌈 kaj amo ❤ de Mia Nordentoft Imperatori",
        copyright: "© Mia Nordentoft Imperatori {0}",
