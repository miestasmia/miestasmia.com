...
var translations = {
    en: {
        ...
        contact: "Contact",
        aboutMe: "About me",
        aboutSub: "My name is Jon, I'm 17 years old and I do software development and linguistics",
        ...
        contact1: "You can send me a DM on Twitter. I'm {0}Locercus{1}@Locercus{2}.",
        contact2: "If you need something a bit more private, feel free to shoot me an email to {0}. Please use OpenPGP when contacting me; chances are I'll ignore your email if you don't encrypt and sign it. My spam filter is quite greedy as well, but any and all OpenPGP email goes through. You can find my public key {1}here{2}.",
    ...
    da: {
        ...
        contact: "Kontakt",
        aboutMe: "Om mig",
        aboutSub: "Jeg hedder Jon, er 17 år og beskæftiger mig med softwareudvikling og lingvistik",
        ...
        aboutText2: "Jeg er fuldtidsstuderende, men har masser af tid til at arbejde på interessante projekter. Jeg bruger hovedsageligt min energi på egne projekter, men jeg har tidligere arbejdet på, og er villig til at arbejde på, andres fri-softwareprojekter. Hvis du har brug for en én smule erfaren udvikler eller bare en oversætter, så skriv endelig til mig, jeg er sandsynligvis interesseret i at hjælpe dig, hvis hvad du laver er interessant. Jeg kan flydende engelsk og dansk, er forholdvist god til Esperanto og {0}har endda lavet mit eget konstruerede sprog{1}.",
...
var translationReplacements = {
    ...
    contact2: [
        '<a href="mailto:lo@cercus.net">lo@cercus.net</a>',
